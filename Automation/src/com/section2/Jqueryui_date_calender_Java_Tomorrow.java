...
public class Jqueryui_date_calender_Java_Tomorrow {
	...
	public static void main(String[] args) {
		...
		cal.add(Calendar.DAY_OF_YEAR, 1); //1 means next day or tomorrow
		//cal.add(Calendar.DAY_OF_YEAR, -1); //-1 means previous day or yesterday
